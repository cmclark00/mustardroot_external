...
define LIBRETRO_SAME_CDI_BUILD_CMDS
	...
	TARGET=mame SUBTARGET=tiny PLATFORM=arm64 \
	NO_USE_PORTAUDIO=1 NO_X11=1 USE_SDL=0 \
	USE_QTDEBUG=0 DEBUG=0 IGNORE_GIT=1 MPARAM=""

	# Then build lr-same-cdi for target
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" $(LIBRETRO_SAME_CDI_EXTRA_ARGS) GIT_VERSION="" -C $(@D) -f Makefile.libretro
endef
